...
public class JDBCTest
{
    ...
    public void enableLoadExtensionTest() throws Exception {
        ...
        try {
            conn = DriverManager.getConnection("jdbc:spatialite4:", prop);
    ...
    public void majorVersion() throws Exception {
        int major = DriverManager.getDriver("jdbc:spatialite4:").getMajorVersion();
        int minor = DriverManager.getDriver("jdbc:spatialite4:").getMinorVersion();
    }
