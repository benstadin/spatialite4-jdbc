...
import org.spatialite.util.OSInfo;

/**
 * Set the system properties, org.spatialite.lib.path, org.spatialite.lib.name,
...
public class SQLiteJDBCLoader {
    ...
    static boolean getPureJavaFlag() {
        return Boolean.parseBoolean(System.getProperty("spatialite.purejava", "false"));
    }
    ...
    private static boolean extractAndLoadLibraryFile(String libFolderForCurrentOS, String libraryFileName,
        ...
        String extractedLibFileName = String.format("spatialite-%s-%s-%s", getVersion(), uuid, libraryFileName);
    ...
    private static void loadSQLiteNativeLibrary() throws Exception {
        ...
        // Try loading library from org.spatialite.lib.path library path */
        String sqliteNativeLibraryPath = System.getProperty("org.spatialite.lib.path");
        String sqliteNativeLibraryName = System.getProperty("org.spatialite.lib.name");
        if(sqliteNativeLibraryName == null) {
            sqliteNativeLibraryName = System.mapLibraryName("spatialitejdbc");
        ...
        sqliteNativeLibraryPath = "/org/spatialite/native/" + OSInfo.getNativeLibFolderPathForCurrentOS();
        ...
        if(!hasNativeLib) {
            if(OSInfo.getOSName().equals("Mac")) {
                ...
                String altName = "libspatialitejdbc.jnilib";
    ...
    public static String getVersion() {
        ...
        URL versionFile = SQLiteJDBCLoader.class.getResource("/META-INF/maven/org.hdm/spatialite-jdbc/pom.properties");
        if(versionFile == null) {
            versionFile = SQLiteJDBCLoader.class.getResource("/META-INF/maven/org.hdm/spatialite-jdbc/VERSION");
        }
