...
public final class NativeDB extends DB
{
    ...
    static {
        if ("The Android Project".equals(System.getProperty("java.vm.vendor"))) {
            System.loadLibrary("spatialitejdbc");
            isLoaded = true;
            loadSucceeded = true;
        } else {
    ...
    /**
     * @see org.spatialite.core.DB#interrupt()
     */
    @Override
    public native void interrupt();

    /**
     * @see org.spatialite.core.DB#busy_timeout(int)
     */
    @Override
    public native synchronized void busy_timeout(int ms);

    /**
     * @see org.spatialite.core.DB#prepare(java.lang.String)
     */
     ...
     * @see org.spatialite.core.DB#column_metadata(long)
     */
    @Override
