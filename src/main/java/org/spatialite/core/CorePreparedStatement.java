...
public abstract class CorePreparedStatement extends JDBC4Statement
{
    ...
    /**
     * @see org.spatialite.core.CoreStatement#finalize()
     */
    @Override
    ...
    /**
     * @see org.spatialite.jdbc3.JDBC3Statement#executeBatch()
     */
    @Override
    ...
    /**
     * @see org.spatialite.jdbc3.JDBC3Statement#getUpdateCount()
     */
    @Override
