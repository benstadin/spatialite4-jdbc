...
import org.spatialite4.util.OSInfo;

/**
 * Set the system properties, org.spatialite4.lib.path, org.spatialite4.lib.name,
...
public class SQLiteJDBCLoader {
    ...
    private static boolean extractAndLoadLibraryFile(String libFolderForCurrentOS, String libraryFileName,
        ...
        String extractedLibFileName = String.format("spatialite4-%s-%s-%s", getVersion(), uuid, libraryFileName);
    ...
    private static void loadSQLiteNativeLibrary() throws Exception {
        ...
        // Try loading library from org.spatialite4.lib.path library path */
        String sqliteNativeLibraryPath = System.getProperty("org.spatialite4.lib.path");
        String sqliteNativeLibraryName = System.getProperty("org.spatialite4.lib.name");
        if(sqliteNativeLibraryName == null) {
            sqliteNativeLibraryName = System.mapLibraryName("spatialite4jdbc");
        ...
        sqliteNativeLibraryPath = "/org/spatialite4/native/" + OSInfo.getNativeLibFolderPathForCurrentOS();
        ...
        if(!hasNativeLib) {
            if(OSInfo.getOSName().equals("Mac")) {
                ...
                String altName = "libspatialite4jdbc.jnilib";
    ...
    public static String getVersion() {
        ...
        URL versionFile = SQLiteJDBCLoader.class.getResource("/META-INF/maven/org.hdm/spatialite4-jdbc/pom.properties");
        if(versionFile == null) {
            versionFile = SQLiteJDBCLoader.class.getResource("/META-INF/maven/org.hdm/spatialite4-jdbc/VERSION");
        }
