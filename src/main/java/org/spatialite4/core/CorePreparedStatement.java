...
import org.spatialite4.jdbc4.JDBC4Statement;
...
public abstract class CorePreparedStatement extends JDBC4Statement
{
    ...
    /**
     * @see org.spatialite4.core.CoreStatement#finalize()
     */
    @Override
    ...
    /**
     * @see org.spatialite4.jdbc3.JDBC3Statement#executeBatch()
     */
    @Override
    ...
    /**
     * @see org.spatialite4.jdbc3.JDBC3Statement#getUpdateCount()
     */
    @Override
