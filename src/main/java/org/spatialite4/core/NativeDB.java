...
package org.spatialite4.core;

import java.sql.SQLException;

import org.spatialite4.Function;
import org.spatialite4.SQLiteJDBCLoader;
...
public final class NativeDB extends DB
{
    ...
    static {
        if ("The Android Project".equals(System.getProperty("java.vm.vendor"))) {
            System.loadLibrary("spatialite4jdbc");
            isLoaded = true;
            loadSucceeded = true;
        } else {
    ...
    /**
     * @see org.spatialite4.core.DB#interrupt()
     */
    @Override
    public native void interrupt();

    /**
     * @see org.spatialite4.core.DB#busy_timeout(int)
     */
    @Override
    public native synchronized void busy_timeout(int ms);

    /**
     * @see org.spatialite4.core.DB#prepare(java.lang.String)
     */
     ...
     * @see org.spatialite4.core.DB#column_metadata(long)
     */
    @Override
