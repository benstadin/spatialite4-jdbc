...
Justin Deoliveira: https://github.com/jdeolive/sqlite-jdbc

Changes:
- SpatiaLite APIs and changes to the driver updated for the latest version
- Tiny cache manager added for new SpatiaLite per-connection cache objects
